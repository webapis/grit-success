import groupByBrandAndPrice from "../ortalama/helper/groupByBrandAndPrice.js";
import calculateWeightedAveragePrice from "../ortalama/helper/calculateWeightedAveragePrice.js";
import formatPriceAsTurkishLira from "../ortalama/helper/formatPriceAsTurkishLira.js";
//import splitArrayIntoChunks from "./splitArrayIntoChunks.js";
import groupItemsByPriceRange from "./groupItemsByPriceRange.js";
import category from "@/app/sponsor-kiyafeti/comp/category.js";
...
debugger
    return {name:m[0],data:m[1].map(m=>{
      debugger
      return {
