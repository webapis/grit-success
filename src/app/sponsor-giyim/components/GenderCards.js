...
const data = [
    { gender: 'Kadın',urlGender:'kadin', index: 0, url: '/sponsor-giyim/kadın/', imageSrc: '/gender/kadin.jpg' },
    { gender: 'Erkek',urlGender:'erkek',  index: 2, url: '/sponsor-giyim/erkek/', imageSrc: '/gender/erkek.jpg' },
    { gender: 'Kız Çocuk',urlGender:'kiz-cocuk',  index: 3, url: '/sponsor-giyim/kiz-cocuk/', imageSrc: '/gender/kiz-cocuk.jpg' },
    { gender: 'Erkek Bebek',urlGender:'erkek-bebek',  index: 4, url: '/sponsor-giyim/erkek-bebek/', imageSrc: '/gender/erkek-bebek.jpg' },
    { gender: 'Kız Bebek',urlGender:'kiz-bebek',  index: 5, url: '/sponsor-giyim/kiz-bebek/', imageSrc: '/gender/kiz-bebek.jpg' },
    { gender: 'Genç',urlGender:'genc',  index: 6, url: '/sponsor-giyim/genc/', imageSrc: '/gender/genc.jpg' },
    { gender: 'Unisex',urlGender:'unisex',  index: 7, url: '/sponsor-giyim/unisex/', imageSrc: '/gender/unisex.jpg' },
