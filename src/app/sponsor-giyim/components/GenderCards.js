...
const ImageWrapper = styled('div')({
  position: 'relative',
  width: '100%',
  paddingTop: '133.33%', // 3:4 aspect ratio, better for portrait images
  overflow: 'hidden',
});
        ...
        <CardActionArea>
          <ImageWrapper>
            <Image
              ...
              style={{ 
                objectFit: 'cover',
                objectPosition: 'top center', // Focus on the top part of the image where the person's face usually is
