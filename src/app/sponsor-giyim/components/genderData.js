...
const data = [
    ...
    { gender: 'Kız Bebek', urlGender: 'kız-bebek', index: 4, url: '/sponsor-giyim/kız-bebek/', imageSrc: '/gender/kiz-bebek.jpg', show: true },
    { gender: 'Erkek Bebek', urlGender: 'erkek-bebek', index: 5, url: '/sponsor-giyim/erkek-bebek/', imageSrc: '/gender/erkek-bebek.jpg', show: true },
