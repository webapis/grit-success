...
const data = [
    ...
    { gender: 'Bebek', urlGender: 'bebek', index: 4, url: '/sponsor-giyim/bebek/', imageSrc: '/gender/bebek.jpg' },
    ...
    { gender: 'Çocuk', urlGender: 'çocuk', index: 6, url: '/sponsor-giyim/çocuk/', imageSrc: '/gender/cocuk.jpg' },
