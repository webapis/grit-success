...
const ProductCard = ({ product }) => {
  ...
  return (
    <Card  sx={{ maxWidth: '100%', margin: '0 auto', textAlign: 'center' }}>
      <Link href={product.link} target="_blank" rel="noopener noreferrer" sx={{ textDecoration: 'none', color: 'inherit' }}>
        <img
          ref={imageEl}
          component="img"
          src={dataURI}
          alt={product.title}
          style={{ borderRadius: '8px', maxWidth: '100%', height: 300, objectFit:'contain' }}
          loading="lazy"  // Lazy load the image
          onError={(e) => (e.target.src = dataURI)}
        ...
        <CardContent>
          <Typography
            ...
            sx={{
              fontSize: {
                xs: '1rem',     // 1rem for small screens
                sm: '1.25rem',  // 1.25rem for medium screens
                md: '1.75rem',  // 1.75rem for large screens
              },
            }}
          >
          ...
          <Typography
            ...
            sx={{
              fontSize: {
                xs: '0.875rem', // 0.875rem for small screens
                sm: '1rem',     // 1rem for medium screens
                md: '1.25rem',  // 1.25rem for large screens
              },
            }}
          >
            {product.brand}
