...
export default function BrandInfor({ description, tag, title, keywords, href }) {
    ...
    return <div className="image-text-box" >
        <img loading="lazy" src={`/brand-images-v1/${tag}1.JPG`} style={{ margin: 5, width: 280, height: 180, objectFit: 'contain' }} alt={`${title} marka web sitesinin ana sayfa ekran görüntüsü`} />
